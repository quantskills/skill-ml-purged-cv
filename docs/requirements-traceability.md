...
| 6–7, 18, 34, 38–40 — OOS facts and metrics | Raw immutable OOS observations retain identities; named/versioned metrics expose overall, per-fold, count, and coverage | `test_evaluation.py` | verified |
...
| 19–20, 22, 26, 51 — canonical dataset evidence | Authoritative ordered Session Axis, stable IDs, read-only arrays and sensitivity-preserving digests | `test_split_plan.py`; digest property | verified |
